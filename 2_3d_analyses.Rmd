...
###Get slopes of the after mine DEM
slope_after <- terrain(mine_after_same, opt = "slope", unit = "degrees")
...
###Plot slope of pre-mine DEM
slope_before <- terrain(mines[[1]], opt = "slope", unit = "degrees")
mapview(mines[[1]])
plot(slope_before)


###Plot difference in slopes
slope_difference <- terrain(mines[[3]], opt = "slope", unit = "degrees")
plot(slope_difference)


###Plot all three slopes
slopes <- brick(slope_before, slope_after, slope_difference)
names(slopes) <- c("PreMine", "PostMine", "Difference")
plot(slopes)
```
...
#View(mine_before_same)

###Make a matrix for the pre-mine data
...
###here a 3D plot of the pre-mining data
pre_matrix %>%
  sphere_shade(texture = 'desert') %>%
...
###Make matrix of the post-mine data
...
####here a 3D plot of the post-mine data
post_matrix %>%
  sphere_shade(texture = 'desert') %>%
